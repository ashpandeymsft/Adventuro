      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto">
            Discover the world's most stunning trekking destinations with detailed guides and local expertise.
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="p-4 sm:p-5">
                ...
                <div className="grid grid-cols-2 gap-2 mb-3 text-xs sm:text-sm text-gray-600">
                  ...
                  <div className="text-nature-forest font-semibold">
                    From ₹2.5K
                  </div>
                </div>
                ...
                <div className="flex space-x-2">
                  ...
                  <button 
                    className="flex-1 inline-flex items-center justify-center px-3 py-2 text-xs sm:text-sm font-medium text-white bg-primary border border-transparent rounded-md hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors"
                    onClick={(e) => {
                      e.stopPropagation();
